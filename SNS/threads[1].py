#to study pythonanywhere presentations
...
<html lang="en" style="height: 100%">
    <head>
        ...
        <link rel="stylesheet" href="/static/CACHE/css/output.efc711839fdd.css" type="text/css" media="screen">
        ...
        <script type="text/javascript">
            var Anywhere = {};
            Anywhere.urls = {};
            Anywhere.csrfToken = "YS94zP33GZkpakJFx2rNUR2bgiNel1hkENSazPlTKWNAq65YNq5ddkLwqWcXjvCl";
        </script>
...
<li class="visible-xs"><a href="https://blog.pythonanywhere.com/" target="_parent" class="blog_link">Blog</a></li>
  ...
  <form class="form" action="" method="post"><input type="hidden" name="csrfmiddlewaretoken" value="YS94zP33GZkpakJFx2rNUR2bgiNel1hkENSazPlTKWNAq65YNq5ddkLwqWcXjvCl">
    <table>
